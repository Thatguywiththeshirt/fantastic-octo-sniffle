...
### 1. Interactive Simulators & Games (Previously part of my MIS689: Applied AI for Business class)
* **Blue ML Designer Simulator (`AeroTerra.html`)**
    * A drag-and-drop puzzle game where you build Machine Learning pipelines.
...
* **AI Town Fish Tank (`ai-tank.html`)**
    * A sleek, tabbed Interactive Project Guide for building a Generative Agent Simulation on a Raspberry Pi. 
...
* **Prompting Resources (`frame.txt` & `prompt.txt`)**
    * Cheat sheets and structured notes on Prompt Engineering frameworks (RCF, APE, RAFT, RISE, STAGES, CLEAR).
...
* **Libraries/Frameworks:** * [Phaser.js](https://phaser.io/) (for *The Roboso Mandate* game engine)
    * [Chart.js](https://www.chartjs.org/) (for data visualization in *AI Town*)
    * [Tailwind CSS](https://tailwindcss.com/) (via CDN for *AI Town* styling)
